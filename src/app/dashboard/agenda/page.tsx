...
export default function AgendaPage() {
  const { user } = useAuth();
  const { appointments, loading, error, loadTodayAppointments } =
    useAppointments();
  const { todayTotal, lastUpdated } = useAppointmentStats();

  useEffect(() => {
    if (user?.uid) {
      loadTodayAppointments(user.uid);
    }
  }, [user?.uid, loadTodayAppointments]);
                    ...
                    primary={
                      ...
                      >
                        ...
                        <Chip
                          ...
                          size="small"
                          color={getServiceTypeColor(appointment.serviceType)}
                          variant="outlined"
                        />
                        <Chip
